public class Employee {
    ...
    public String toString(){
            ...
            return "Name : " + this.getName() + " || Salary : " + this.getSalary() + " Workhours " +  this.getWorkHours()
                    + " Hireyear : " + this.getHireYear()
                + " Bonus : " + this.bonus() + " Tax : " + this.tax() + " Raisesalary " + this.raiseSalary() + " Totalsalary " + totalSalary ;
    }
